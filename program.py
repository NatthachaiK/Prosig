...
API_KEY = "15f5be80-28b5-49c1-8650-5768b5512577" # Your API KEY here
...
while pd.to_datetime("now") < end_datetime:
    ...
    if data:
        ...
        data_df.to_csv('AQI_PM2_5_Egypt.csv', mode='a', index=False, header=not pd.DataFrame(columns=columns).empty)
